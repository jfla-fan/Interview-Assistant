...
public:
	...
	public:
        ...
        //! NEW translates native shortuct into Qt key combination
        QKeyCombination toKeyCombination() const;
    ...
    //! NEW checks if hotkeys are enabled globally
    static bool isEnabled();

    //! NEW sets hotkey handling globally
