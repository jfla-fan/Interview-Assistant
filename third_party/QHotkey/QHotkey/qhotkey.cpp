...
void QHotkey::setEnabled(bool value)
{
    QHotkeyPrivate::instance()->setEnabled(value);
}

bool QHotkey::isEnabled()
{
    return QHotkeyPrivate::instance()->isEnabled();
}
...
void QHotkeyPrivate::setEnabled(bool value)
{
    enabled.store(value, std::memory_order_relaxed);
}

bool QHotkeyPrivate::isEnabled() const
{
    return enabled;
}
...
QKeyCombination QHotkey::NativeShortcut::toKeyCombination() const
{
    return QHotkeyPrivate::instance()->keyCombinationFromNative(*this);
}
